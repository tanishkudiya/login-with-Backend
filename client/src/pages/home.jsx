            ...
            <Box className="home"
                ...
                <Box className="homeContainer">
                    <div>
                        ...
                        <a href="#" className="btn btn-success" onClick={() => toggleTheme()}>Toggle Mode</a>
                        <Link to={"/menu"} ><Button variant="contained" color="success" sx={{ mt: 1, cursor: "pointer" }}  >join Now</Button></Link>
                    </div>
                </Box>
            </Box>
            <br />
